...
<body class="main1">
    ...
    <div class="edit">
        ...
        ?>
        <div id="edit_meaning"><?= $result2['meaning'] ?></div>
        <div id="edit_word"><?= $result['word'] ?></div>
        <div class="edit_script"><?= $result['sentence'] ?></div>

        <svg class="submit_ellipse" style="transform:rotate(90deg)" width="30" height="44" viewBox="0 0 30 44" fill="none" xmlns="http://www.w3.org/2000/svg">
